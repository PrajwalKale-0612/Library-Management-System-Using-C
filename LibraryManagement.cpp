...
void addBook()
{
    ...
    printf("Enter the Book User Name : \n");
    fgets(book.userName, sizeof(book.userName), stdin);
    book.userName[strcspn(book.userName, "\n")] = 0;
...
void searchBook(int searchId)
{
    ...
    if (!isFound)
    {
        printf("\n\n\n%d Book Id Data are not found in data.txt file\n\n",
               searchId);
    }
...
void updateBook(int searchId)
{
                  ...
                  &book.total) !=EOF)
    {
        if (book.bId == searchId)
        {
            ...
            printf("\nEnter the updated  Book User Name: ");
            fgets(book.userName,
            ...
            printf("Enter the updated book quantity: ");
            scanf("%d", &book.bQty);
    ...
    if (isfound)
    {
        printf("\nRecord updated successfully in data.txt file\n");
    }
    else
    {
        printf("\nBook ID not found in data.txt file, "
...
void deleteBook(int deleteId)
{
    ...
    {
        printf("Book ID not found in data.txt file "
...
void showAllBook()
{
    ...
    printf("\n\n");
    printf("---------------------------------------------------------------------------------------------------------------------------\n");
    printf("             Show Whole Book Record in the data.txt\n");
    printf("----------------------------------------------------------------------------------------------------------------------------\n\n");

    printf("%-10s %-30s %-20s %-30s %-10s %-10s %-10s\n",
           "Book ID",
           "Book Name",
           "Book Author",
           "Book User Name",
    ...
    while (fscanf(fp1,
                  ...
                  &book.total) !=EOF)
    {
        printf("%-10d %-30s %-20s %-30s %-10d %-10.2f %-10.2f\n",
               book.bId,
               book.bName,
               book.bAuthor,
               book.userName,
